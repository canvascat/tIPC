...
function freezeIfAvailable(obj: object) {
  if (Object.freeze) {
    Object.freeze(obj)
  }
}
 ...
 * @internal
 */
export function createRecursiveProxy<TFaux = unknown>(callback: ProxyCallback): TFaux {
 ...
 * @internal
 */
export function createFlatProxy<TFaux>(callback: (path: string & keyof TFaux) => any): TFaux {
